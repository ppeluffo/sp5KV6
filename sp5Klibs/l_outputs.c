...
void OUT_config(void)
{
	...
	// Como en sp5K los manejo desde el MCP23018 no debo inicializar pines del micro.
}
//------------------------------------------------------------------------------------
void OUT_power_on(void)
{
	// Prende la fuente de 12V que alimenta el DRV8814
	// En sp5K estan directamente conectados a 12V
}
//------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------
int OUT_sleep_pin( uint8_t valor )
{
...
//------------------------------------------------------------------------------------
int OUT_reset_pin( uint8_t valor )
{
...
//------------------------------------------------------------------------------------
int OUT_enable_pin( char driver_id, uint8_t valor )
{
